            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    ?>
                        ...
                        <li class="<?php echo e(Request::url() == route('cms', $footer_menu->page_slug) ? 'active' : ''); ?>"><a href="<?php echo e(route('cms', $footer_menu->page_slug)); ?>">
...
<!-- <div class="copyright">
 ...
 --><?php /**PATH C:\xampp\htdocs\prozjobs\resources\views/includes/footer.blade.php ENDPATH**/ ?>