...
<form action="{{route('job.seeker.list')}}" method="get">
	<div class="searchbar">
		...
		<!-- id="empsearch" -->
		  <input type="text"  name="search"  value="{{Request::get('search', '')}}" class="form-control functional_find" placeholder="{{__('Search Job Role...')}}" autocomplete="off" style="padding: 0px 0px 0px 10px"/>
		  <span class="input-group-btn" style="padding-top:5px">
			<input type="submit" class="btn" value="{{__('Search Applicant Role')}}">
		  </span>
		</div>
		</div>
	</div>
