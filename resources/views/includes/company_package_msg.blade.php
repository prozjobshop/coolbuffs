<div class="instoretxt">
    ...
    <div class="credit">{{__('Available Downloads')}} : <strong>{{ Auth::guard('company')->user()->availed_download_resume_quota }}</strong> / <strong>{{ Auth::guard('company')->user()->download_resume_quota }}</strong></div>
