<div class="instoretxt">
    ...
    <div class="credit">{{__('Viewed CVs')}} : <strong>{{ Auth::guard('company')->user()->availed_viewed_resume_quota }}</strong> / <strong>{{ Auth::guard('company')->user()->viewed_resume_quota }}</strong></div>
</div>
